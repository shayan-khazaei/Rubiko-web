  ...
  return (
    <div className="flex flex-col items-center gap-5">
      <p className="w-3xl text-center text-2xl text-grey-800 pb-7">
        ...
        all over the world will continue to discover the power and endless
        possibilities (well, almost endless. 43 quintillion is still finite!)
        the Rubik’s Cube offers. So, grab a Rubik’s Cube and join the Cube
        community to become part of this rich history. The world is always in
        need of solvers!
      </p>
    </div>
  );
